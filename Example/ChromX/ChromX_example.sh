...
# Start to run OTTERS
cd ${OTTERS_DIR}/Example/ChromX

# Input for OTTERS STAGE I 
# Annotation File 
exp_anno=ChromX_exp_anno.txt
# Genotype data from LD reference panel
geno_dir=ChromX_Exp_geno
# eQTL summary statistics 
sst_file=ChromX_Exp_eQTLSumStats.txt
# Input for OTTERS STAGE II
# GWAS summary statistics 
gwas_sst_file=ChromX_Exp_GWASSumStats.txt
